define('ember-simple-auth/mixins/application-route-mixin', ['exports', 'ember', './../configuration'], function (exports, _ember, _configuration) {
  'use strict';
    ...
    */
    sessionAuthenticated: function sessionAuthenticated() {
      ...
      if (attemptedTransition) {
        ...
        this.transitionTo(_configuration['default'].routeAfterAuthentication);
      }
    },
