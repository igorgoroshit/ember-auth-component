define('ember-simple-auth/mixins/authenticated-route-mixin', ['exports', 'ember', './../configuration'], function (exports, _ember, _configuration) {
  'use strict';
    ...
    */
    beforeModel: function beforeModel(transition) {
      if (!this.get('session.isAuthenticated')) {
        ...
        _ember['default'].assert('The route configured as Configuration.authenticationRoute cannot implement the AuthenticatedRouteMixin mixin as that leads to an infinite transitioning loop!', this.get('routeName') !== _configuration['default'].authenticationRoute);
